...
*  \#154347 - Exception no longer thrown when remove or replace data point after notify the [`SuspendSeriesNotification`](http://help.syncfusion.com/uwp/sfchart/how-to/add-range-of-points-dynamically).
...
*  \#154255 - [`TextAnnotation`](http://help.syncfusion.com/uwp/sfchart/annotations#textannotation) positions proper, when the annotations are added dynamically.
