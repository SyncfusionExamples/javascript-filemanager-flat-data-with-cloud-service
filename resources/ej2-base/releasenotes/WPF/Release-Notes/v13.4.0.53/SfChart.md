...
* Implemented serialization support for SfChart. [Click here](http://help.syncfusion.com/wpf/sfchart/how-to/serialize-the-sfchart) for more information.
* Enhanced the data label position options based on series types. Please refer [this](http://help.syncfusion.com/wpf/sfchart/adornments#smartlabel-alignment) help document.
* Provided the data label support for the histogram chart.
* Implemented the support to explode the segment of pie, doughnut, pyramid and funnel series by clicking/tapping. Please refer [this](http://help.syncfusion.com/cr/cref_files/wpf/Syncfusion.SfChart.WPF~Syncfusion.UI.Xaml.Charts.AccumulationSeriesBase~ExplodeOnMouseClick.html) link.
...
* \#144009 - Added 'IsClosed' property for area type series, [Click here](http://help.syncfusion.com/cr/cref_files/wpf/Syncfusion.SfChart.WPF~Syncfusion.UI.Xaml.Charts.AreaSeries~IsClosed.html) for API details.
