...
- **Content alignment** - Provides an option to align the message content with predefined content alignments. The available content alignments such as `Left`, `Center`, and `Right`.
