...
- Added support for .NET Standard 1.6 Framework in `Syncfusion.EJ2.DocumentEditor` NuGet package.
...
- Included TagHelper support to the textbox component that renders floating label with minimum configuration.
