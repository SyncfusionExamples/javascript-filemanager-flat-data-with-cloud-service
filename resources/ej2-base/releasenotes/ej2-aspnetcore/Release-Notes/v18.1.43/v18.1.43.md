...
| `<e-spreadsheet-rangesettings>`<br/>`<e-spreadsheet-rangesetting>` | `<e-spreadsheet-ranges>`<br/>`<e-spreadsheet-range>` | 
...
- `#269067`- Checkbox selection works properly with aggregates enabled.
