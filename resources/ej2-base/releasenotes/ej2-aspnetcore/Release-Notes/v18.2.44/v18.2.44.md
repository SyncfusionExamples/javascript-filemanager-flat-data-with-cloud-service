...
- Now `data`, `row` these Tree Grid selection event arguments are get array values only when we perform multi selection. Find modified event arguments and it types from the below table,
