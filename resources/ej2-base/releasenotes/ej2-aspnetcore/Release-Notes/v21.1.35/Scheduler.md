...
- `#I324269`, `#I347160` - Provided support to display multi month event as single event in vertical orientation of timeline year view. Find the UG documentation link [here](https://ej2.syncfusion.com/aspnetcore/documentation/schedule/views#timeline-year-view).
