...
* Added support to get and set custom properties in the form fields. Find the UG documentation link [here](https://help.syncfusion.com/file-formats/pdf/working-with-forms).
* Provided support to add an image in the center of QRCode in PDF and Image. Find the UG documentation link [here](https://help.syncfusion.com/file-formats/pdf/working-with-images).
* \#F179088 – Provided support for retrieving custom images from rubber stamp annotations. Find the UG documentation link [here](https://help.syncfusion.com/file-formats/pdf/working-with-annotations#rubber-stamp-annotation).
* Provided support for [importing](https://help.syncfusion.com/file-formats/pdf/working-with-annotations#importing-annotations-from-json-file) and [exporting](https://help.syncfusion.com/file-formats/pdf/working-with-annotations#exporting-annotations-to-json-file) annotations with an appearance in JSON format.
* \#I420880 – Provided support for adding TrueType fonts with full embedding. Find the UG documentation link [here](https://help.syncfusion.com/file-formats/pdf/working-with-text#embedding-fonts-and-working-with-unicode-text).
* Provided support for converting TIFF images to PDF in .NET projects. Find the UG documentation link [here](https://help.syncfusion.com/file-formats/pdf/working-with-images#converting-multi-page-tiff-to-pdf).
* Provided support for extracting accessibility tags from the PDF documents. Find the UG documentation link [here](https://help.syncfusion.com/file-formats/pdf/working-with-tagged-pdf).
