...
- `#FB30604` - Now, component will not allow to enter the decimal separator in mobile device while setting `decimal` property value as 0 and enabled `validateDecimalOntype` property.
