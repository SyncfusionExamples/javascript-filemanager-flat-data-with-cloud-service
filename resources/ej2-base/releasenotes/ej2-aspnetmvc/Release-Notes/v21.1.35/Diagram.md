...
- `#I412159` - Provided support to trigger an event when the connector segment is dragged. Find the UG documentation link [here](https://ej2.syncfusion.com/aspnetmvc/documentation/chart/legend).