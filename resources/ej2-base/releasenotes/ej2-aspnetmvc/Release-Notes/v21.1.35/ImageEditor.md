...
- Provided pinch zoom support to zoom in or out the image while performing pinch on touch enabled devices. Find the UG documentation link [here](https://ej2.syncfusion.com/aspnetmvc/documentation/image-editor/transform#zoom).
- Provided mouse wheel zoom support to zoom in/out the image while scrolling mouse wheel with ctrl key press. Find the UG documentation link [here](https://ej2.syncfusion.com/aspnetmvc/documentation/image-editor/transform#zoom).
