...
* PDF-to-image conversion - This PDF to image converter library allows converting PDF documents to images without opening the document in the PDF Viewer control. It supports various customizations in image conversion, such as setting a transparent background and removing annotations from a specific page or range of pages.
