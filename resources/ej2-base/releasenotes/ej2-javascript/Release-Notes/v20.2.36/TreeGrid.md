...
- `#I367483` - Provided support for row indent and outdent functionality. Please find the demo link [here](https://ej2.syncfusion.com/javascript/demos/#/bootstrap5/tree-grid/inline.editing).
