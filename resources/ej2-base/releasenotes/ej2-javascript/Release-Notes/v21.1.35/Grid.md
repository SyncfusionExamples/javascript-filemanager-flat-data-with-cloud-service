...
- `#I428772` - Fixed alignment issue with Dialog component header content and close icon on fluent theme. [More Information](https://ej2.syncfusion.com/javascript/documentation/release-notes/20.4.49/#dialog?type=all?type=all).
...
- The `td` element for `e-detailcell` in [detail element](https://ej2.syncfusion.com/javascript/documentation/grid/row/detail-template/) has been only changed from a `td` element to the `th` element to enhance accessibility standards.
