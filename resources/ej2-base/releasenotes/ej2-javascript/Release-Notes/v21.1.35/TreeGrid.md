...
- The `td` element for `e-detailcell` in [detail element](https://ej2.syncfusion.com/javascript/documentation/treegrid/row/detail-template/) has been only changed from a `td` element to the `th` element to enhance accessibility standards.
