...
* The selection feature's APIs revamped based on the application usage. For current API details in the selection feature, refer to this [link](https://help.syncfusion.com/winui/circular-charts/selection).
